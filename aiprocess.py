...
f"- If the user asks a question or gives a command not matching any predefined function, use AI search and return the result in the format: 'AI mode: <answer>'.\n\n"
f"Commands List:\n"
f"{commands_list}\n\n"
